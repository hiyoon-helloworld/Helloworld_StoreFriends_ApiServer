...
-- -----------------------------------------------------
INSERT INTO `user_employee` (`seq`, `owner_seq`, `name`, `type`, `code`, `work_start_date`, `work_end_date`, `birthday`, `phone`, `memo`, `del_yn`, `regdate`) VALUES (1, 1, '담당자1', '0', '1111', '160501', '161031', '850130', '010-2222-2222', NULL, '0', NOW());
INSERT INTO `user_employee` (`seq`, `owner_seq`, `name`, `type`, `code`, `work_start_date`, `work_end_date`, `birthday`, `phone`, `memo`, `del_yn`, `regdate`) VALUES (2, 1, '담당자2', '1', '1111', '160501', '161130', '880921', '010-3333-3333', NULL, '0', NOW());

-- -----------------------------------------------------
-- Data for table `user_pos`
-- -----------------------------------------------------
INSERT INTO `user_pos` (`seq`, `manager_seq`, `type`, `mac_address`, `del_yn`, `regdate`) VALUES (1, 1, '0', '08-62-66-2D-F3-0C', '0', NOW());
INSERT INTO `user_pos` (`seq`, `manager_seq`, `type`, `mac_address`, `del_yn`, `regdate`) VALUES (2, 1, '1', '08-62-66-2D-F3-0D', '0', NOW());
