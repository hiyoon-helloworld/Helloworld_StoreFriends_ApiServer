...
CREATE TABLE IF NOT EXISTS `user_admin` (
  ...
  `receipt_email_yn` CHAR(1) NULL,
  `error_email_yn` CHAR(1) NULL,
  `login_cnt` INT NULL,
...
CREATE TABLE IF NOT EXISTS `store_seller` (
  ...
  `use_yn` CHAR(1) NOT NULL DEFAULT '0' COMMENT '사용여부(0: false, 1: true)',
  `del_yn` CHAR(1) NOT NULL DEFAULT '0' COMMENT '삭제여부(0: false, 1: true)',
...
CREATE TABLE IF NOT EXISTS `user_manager` (
  ...
  `use_yn` CHAR(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `store_owner` (
  ...
  `bizapp_use_yn` CHAR(1) NULL DEFAULT '0' COMMENT '사장님앱 사용여부(0: 사용안함, 1: 사용함)',
  `del_yn` CHAR(1) NOT NULL DEFAULT '0',
  `regdate` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`seq`),
...
CREATE INDEX `fk_owner_seller_idx` ON `store_owner` (`seller_seq` ASC);

CREATE INDEX `fk_owner_manager_idx` ON `store_owner` (`manager_seq` ASC);
...
CREATE TABLE IF NOT EXISTS `user_manager_business` (
  ...
  `billing_publish_yn` CHAR(1) NULL COMMENT '청구서발행여부',
...
CREATE TABLE IF NOT EXISTS `statistics_user_login` (
  `seq` BIGINT UNSIGNED NOT NULL COMMENT 'ADMIN / USER SEQ',
...
CREATE TABLE IF NOT EXISTS `store` (
  ...
  `tts_use_yn` CHAR(1) NULL COMMENT 'ARS 사용여부(0: 사용안함, 1: 사용함)',
  `tts_notify_use_yn` CHAR(1) NULL COMMENT 'ARS 알림 사용여부',
  ...
  `regdate` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '등록일',
  PRIMARY KEY (`seq`),
  CONSTRAINT `fk_store_owner_idx`
    FOREIGN KEY (`owner_seq`)
    REFERENCES `store_owner` (`seq`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '가맹점 테이블';

CREATE INDEX `fk_store_owner_idx` ON `store` (`owner_seq` ASC);
...
CREATE TABLE IF NOT EXISTS `user_employee` (
  ...
  PRIMARY KEY (`seq`),
  CONSTRAINT `fk_employee_owner_idx`
    FOREIGN KEY (`owner_seq`)
    REFERENCES `store_owner` (`seq`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_employee_owner_idx` ON `user_employee` (`owner_seq` ASC);
...
CREATE TABLE IF NOT EXISTS `store_mobile_web` (
  ...
  `run24_yn` CHAR(1) NOT NULL DEFAULT '0' COMMENT '24 운영여부(0: false, 1: true)',
  `open_year_round_yn` CHAR(1) NOT NULL DEFAULT '0' COMMENT '연중무휴여부 (0: fasle, 1: true)',
  ...
  `use_yn` CHAR(1) NULL DEFAULT '0' COMMENT '사용여부(0: false, 1: true)',
  `regdate` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '등록일',
...
-- -----------------------------------------------------
-- Table `store_owner_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `store_owner_address` (
  ...
  PRIMARY KEY (`seq`),
  CONSTRAINT `fk_owner_address_owner_idx`
    FOREIGN KEY (`owner_seq`)
    REFERENCES `store_owner` (`seq`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `store_table` (
  ...
  `use_yn` CHAR(1) NULL DEFAULT '0' COMMENT '사용여부(0: false, 1: true)',
  `del_yn` CHAR(1) NULL DEFAULT '0' COMMENT '삭제여부(0: false, 1: true)',
  PRIMARY KEY (`seq`),
...
CREATE TABLE IF NOT EXISTS `category_store` (
  ...
  `del_yn` CHAR(1) NULL COMMENT '삭제여부(0: false, 1: true)',
  PRIMARY KEY (`seq`),
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `paynow_order_yn` CHAR(1) NULL COMMENT '페이나우 주문 여부',
  ...
  `total_price` INT NULL COMMENT '주문 총 금액',
  `discount_type` CHAR(1) NULL DEFAULT '0' COMMENT '할인타입(0: 금액, 1: 퍼센트)',
  `discount_price` INT NULL COMMENT '할인 금액',
  `discount_rate` DECIMAL(3,1) NULL COMMENT '할인율',
  `use_point` INT NULL COMMENT '포인트 사용',
  `payment_price` INT NULL COMMENT '최종 결재 금액',
  `save_point` INT NULL COMMENT '적립 포인트',
  `nopay_yn` CHAR(1) NULL COMMENT '외상여부(0: false, 1: true)',
  `moddate` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수정일',
  `regdate` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '등록일',
  PRIMARY KEY (`seq`),
...
CREATE TABLE IF NOT EXISTS `order_push_tts` (
  ...
  `push_delay_yn` CHAR(1) NOT NULL DEFAULT '0' COMMENT '지연 여부(0: false, 1: true)',
  `push_notify_yn` CHAR(1) NOT NULL DEFAULT '0' COMMENT '통지 여부(0: false, 1: true)',
  `push_complete_message` VARCHAR(300) NULL COMMENT '완료 메시지',
  `push_fail_message` VARCHAR(300) NULL COMMENT '실패 메시지',
  `tts_use_yn` CHAR(1) NOT NULL DEFAULT '0' COMMENT 'ARS 여부(0: false, 1: true)',
  `tts_missed_yn` CHAR(1) NOT NULL DEFAULT '0' COMMENT 'ARS 실패여부(0: false, 1: true)',
...
CREATE INDEX `fk_store_cid_owner_idx` ON `store_cid` (`owner_seq` ASC);
...
CREATE TABLE IF NOT EXISTS `store_operation` (
  ...
  `reserve_fund` INT UNSIGNED NOT NULL COMMENT '준비금',
  PRIMARY KEY (`seq`),
  CONSTRAINT `fk_operation_owner_idx`
    FOREIGN KEY (`owner_seq`)
    REFERENCES `store_owner` (`seq`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_operation_owner_idx` ON `store_operation` (`owner_seq` ASC);
...
CREATE TABLE IF NOT EXISTS `user_pos` (
  ...
  `owner_seq` BIGINT UNSIGNED NOT NULL,
  `type` CHAR(1) NOT NULL DEFAULT '0' COMMENT 'POS타입 (0: MAIN, 1: ETC)',
  `mac_address` VARCHAR(100) NOT NULL,
  `del_yn` CHAR(1) NOT NULL DEFAULT '0' COMMENT '삭제여부',
  `regdate` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`seq`),
...
CREATE INDEX `fk_pos_owner_idx_idx` ON `user_pos` (`owner_seq` ASC);
